...
local function stage12RecoverMappingsSync()
    if type(State.CurrentMappings) == "table" and #State.CurrentMappings > 0 then
        return true
    end
    local bundleId = nil
...
local function stage12DoApply(reason)
...
local function stage12StickyReapply(reason)
...
local function stage12WatchAnimate()
